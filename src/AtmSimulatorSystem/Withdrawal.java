...
public class Withdrawal extends JFrame implements ActionListener{
    ...
    public Withdrawal()
    {
        ...
        l4 = new JLabel("(Maximum Amount that can be withdrawn is Rs 10,000)");
        l4.setFont(new Font("Raleway", Font.BOLD,20));
        
        setLayout(null);
        
        l4.setBounds(50,80,600,30);
        add(l4);
        
        l1.setBounds(60,130,500,30);
        add(l1);
        
        l2.setBounds(180,180,500,60);
        add(l2);
                ...
                else
                {
                    ...
                    if(rs.next())
                    {
                        ...
                        else
                        {
                                ...
                                JOptionPane.showMessageDialog(null,"Rs. "+d+" withdrawn Succesfully");
                        }
